...
public class MyGoldDetector extends DogeCVDetector {
    ...
    public Mat process(Mat input) {
        ...
        for(MatOfPoint cont : contoursYellow){
            ...
            if(score < bestDiffrence && rect.y < 100){ //looks for only the rectangles that are in the bottom (height-200 pixels) of the screen to avoid picking up minerals in the crater
